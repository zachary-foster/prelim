...
In order for an adaptive seed microbiome maintained through vertical transmission to be possible, the following phenomena must exist:

* Microbes associated with plants must provide some benefit to plant fitness.
* Plant genotype must be able to influence the assortment of microbes present and maintained in plant tissues and such effects must be heritable.
* Microbes must be present in seed or associated with seed and be able to be vertically transmitted to the next generation reliably.
...
This could result in the combination of the plant and a subset of its microbiome being effectively a single organism in an evolutionary sense (i.e. a "holobiont"), just as mitochondria and chloroplasts are now integrated into eukaryotic cells [@sagan1967origin].
Any microbes evolving along this pattern could be thought of as heritable genetic elements, such as plasmids or plastids.
...
There is a long history of research confirming the presence and benefit of endophytes in grasses.
