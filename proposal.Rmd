...
* Microbes assocaited with plants must provide some benifit to plant health and fecundity.
* Plant genotype must be able to influence the assotment of microbes present and maintained in plant tissues.
* Microbes must be present in seed and be able to be vertically transmitted to the next generation relaibly.

If these three processes coocure in a plant over many generations, then it is possible that the evolution of the plant and its microbiome could become linked and the survival of both depend upon the other.
...
#### The effect of microbial symbionts on plant health


#### The effect of plant genotype on microbiome


#### Vertical transmission of microbes via seed

Evidence is accumulating that microbes present in the seeds of some plant species can innoculate the next generation and thus potentially be sustained indefinitly.
...
#### Metabarcoding can avoid the limitations of past research
